...
struct SMBDataPointers
{
    ...
    SMBDataPointers()
    {
        ...
        this->KickedShellXSpdData_ptr = 0x9a5d;
        this->DemotedKoopaXSpdData_ptr = 0x9a5f;
        this->KickedShellPtsData_ptr = 0x9a61;
        this->StompedEnemyPtsData_ptr = 0x9a64;
        this->RevivalRateData_ptr = 0x9a68;
        this->SetBitsMask_ptr = 0x9a6a;
        this->ClearBitsMask_ptr = 0x9a71;
        this->PlayerPosSPlatData_ptr = 0x9a78;
        this->PlayerBGUpperExtent_ptr = 0x9a7a;
        this->AreaChangeTimerData_ptr = 0x9a7c;
        this->ClimbXPosAdder_ptr = 0x9a7e;
        this->ClimbPLocAdder_ptr = 0x9a80;
        this->FlagpoleYPosData_ptr = 0x9a82;
        this->SolidMTileUpperExt_ptr = 0x9a87;
        this->ClimbMTileUpperExt_ptr = 0x9a8b;
        this->EnemyBGCStateData_ptr = 0x9a8f;
        this->EnemyBGCXSpdData_ptr = 0x9a95;
        this->BoundBoxCtrlData_ptr = 0x9a97;
        this->BlockBufferAdderData_ptr = 0x9ac7;
        this->BlockBuffer_X_Adder_ptr = 0x9aca;
        this->BlockBuffer_Y_Adder_ptr = 0x9ae6;
        this->VineYPosAdder_ptr = 0x9b02;
        this->FirstSprXPos_ptr = 0x9b04;
        this->FirstSprYPos_ptr = 0x9b08;
        this->SecondSprXPos_ptr = 0x9b0c;
        this->SecondSprYPos_ptr = 0x9b10;
        this->FirstSprTilenum_ptr = 0x9b14;
        this->SecondSprTilenum_ptr = 0x9b18;
        this->HammerSprAttrib_ptr = 0x9b1c;
        this->FlagpoleScoreNumTiles_ptr = 0x9b20;
        this->JumpingCoinTiles_ptr = 0x9b2a;
        this->PowerUpGfxTable_ptr = 0x9b2e;
        this->PowerUpAttributes_ptr = 0x9b3e;
        this->EnemyGraphicsTable_ptr = 0x9b42;
        this->EnemyGfxTableOffsets_ptr = 0x9c44;
        this->EnemyAttributeData_ptr = 0x9c5f;
        this->EnemyAnimTimingBMask_ptr = 0x9c7a;
        this->JumpspringFrameOffsets_ptr = 0x9c7c;
        this->DefaultBlockObjTiles_ptr = 0x9c81;
        this->ExplosionTiles_ptr = 0x9c85;
        this->PlayerGfxTblOffsets_ptr = 0x9c88;
        this->PlayerGraphicsTable_ptr = 0x9c98;
        this->SwimKickTileNum_ptr = 0x9d68;
        this->IntermediatePlayerData_ptr = 0x9d6a;
        this->ChangeSizeOffsetAdder_ptr = 0x9d70;
        this->ObjOffsetData_ptr = 0x9d84;
        this->XOffscreenBitsData_ptr = 0x9d87;
        this->DefaultXOnscreenOfs_ptr = 0x9d97;
        this->YOffscreenBitsData_ptr = 0x9d9a;
        this->DefaultYOnscreenOfs_ptr = 0x9da3;
        this->HighPosUnitData_ptr = 0x9da6;
        this->SwimStompEnvelopeData_ptr = 0x9da8;
        this->ExtraLifeFreqData_ptr = 0x9db6;
        this->PowerUpGrabFreqData_ptr = 0x9dbc;
        this->PUp_VGrow_FreqData_ptr = 0x9dda;
        this->BrickShatterFreqData_ptr = 0x9dfa;
        this->MusicHeaderData_ptr = 0x9e0a;
        this->TimeRunningOutHdr_ptr = 0x9e3b;
        this->Star_CloudHdr_ptr = 0x9e40;
        this->EndOfLevelMusHdr_ptr = 0x9e46;
        this->UndergroundMusHdr_ptr = 0x9e4b;
        this->SilenceHdr_ptr = 0x9e50;
        this->CastleMusHdr_ptr = 0x9e54;
        this->VictoryMusHdr_ptr = 0x9e59;
        this->GameOverMusHdr_ptr = 0x9e5e;
        this->WaterMusHdr_ptr = 0x9e63;
        this->WinCastleMusHdr_ptr = 0x9e69;
        this->GroundLevelPart1Hdr_ptr = 0x9e6e;
        this->GroundLevelPart2AHdr_ptr = 0x9e74;
        this->GroundLevelPart2BHdr_ptr = 0x9e7a;
        this->GroundLevelPart2CHdr_ptr = 0x9e80;
        this->GroundLevelPart3AHdr_ptr = 0x9e86;
        this->GroundLevelPart3BHdr_ptr = 0x9e8c;
        this->GroundLevelLeadInHdr_ptr = 0x9e92;
        this->GroundLevelPart4AHdr_ptr = 0x9e98;
        this->GroundLevelPart4BHdr_ptr = 0x9e9e;
        this->GroundLevelPart4CHdr_ptr = 0x9ea4;
        this->DeathMusHdr_ptr = 0x9eaa;
        this->Star_CloudMData_ptr = 0x9eb0;
        this->GroundM_P1Data_ptr = 0x9ef9;
        this->SilenceData_ptr = 0x9f14;
        this->GroundM_P2AData_ptr = 0x9f41;
        this->GroundM_P2BData_ptr = 0x9f6d;
        this->GroundM_P2CData_ptr = 0x9f95;
        this->GroundM_P3AData_ptr = 0x9fba;
        this->GroundM_P3BData_ptr = 0x9fd3;
        this->GroundMLdInData_ptr = 0x9ff1;
        this->GroundM_P4AData_ptr = 0xa01d;
        this->GroundM_P4BData_ptr = 0xa043;
        this->DeathMusData_ptr = 0xa06a;
        this->GroundM_P4CData_ptr = 0xa06c;
        this->CastleMusData_ptr = 0xa09c;
        this->GameOverMusData_ptr = 0xa13d;
        this->TimeRunOutMusData_ptr = 0xa16a;
        this->WinLevelMusData_ptr = 0xa1a8;
        this->UndergroundMusData_ptr = 0xa209;
        this->WaterMusData_ptr = 0xa24a;
        this->EndOfCastleMusData_ptr = 0xa349;
        this->VictoryMusData_ptr = 0xa3c0;
        this->FreqRegLookupTbl_ptr = 0xa3f8;
        this->MusicLengthLookupTbl_ptr = 0xa45e;
        this->EndOfCastleMusicEnvData_ptr = 0xa48e;
        this->AreaMusicEnvData_ptr = 0xa492;
        this->WaterEventMusEnvData_ptr = 0xa49a;
        this->BowserFlameEnvData_ptr = 0xa4c2;
        this->BrickShatterEnvData_ptr = 0xa4e2;
        this->freeSpaceAddress = 0xa4f2;
    }
};
